...
include(":features:add-apartamento:ui")
include(":features:add-apartamento:domain")
include(":features:add-pessoa:domain")
include(":features:add-pessoa:ui")
include(":features:add-morador:domain")
include(":features:add-morador:ui")
